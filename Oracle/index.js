...
lineReader.on('line', function (line) {
  ...
  for (w = 0; w < words.length; w++) {                            /* Loop through all words in current line */
    ...
    for (var q = 0; q < uniqueLetters.length; q++) {
      var demandHash = letterMonitor.at(letterMonitorAddresses[uniqueLetters[q]]).incrementDemand(amounts[q]);
    }
  ...
  iterations+=1;
  console.log("Demand: ", blockChainDemand.toString());
